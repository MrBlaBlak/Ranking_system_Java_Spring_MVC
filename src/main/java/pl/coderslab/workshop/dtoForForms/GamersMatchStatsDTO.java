...
public class GamersMatchStatsDTO {
    ...
    public String toString() {
        return "GamersMatchStatsDTO{" +
                ...
                ", suddenDeathWhoWon='" + suddenDeathWhoWon + '\'' +
                ", team1titans=" + Arrays.toString(team1titans) +
                ", team2titans=" + Arrays.toString(team2titans) +
                ", team1gamersId=" + Arrays.toString(team1gamersId) +
                ", team1elims=" + Arrays.toString(team1elims) +
                ", team1flags=" + Arrays.toString(team1flags) +
                ", team2gamersId=" + Arrays.toString(team2gamersId) +
                ", team2elims=" + Arrays.toString(team2elims) +
                ", team2flags=" + Arrays.toString(team2flags) +
                ", mapPlayed='" + mapPlayed + '\'' +
                '}';
    }
}
