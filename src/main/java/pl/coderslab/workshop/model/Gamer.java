...
//    public static void instantiate_new_gamers(){
...
//        System.out.println("Type `quit` to stop inputing gamers");
//        while(true){
//            name = scanner.nextLine();
//            if(name.equals("quit")) {
//                break;
//            }
//            mmr = Double.parseDouble(scanner.nextLine());
//            server = scanner.nextLine();
//            lastTen = Integer.parseInt(scanner.nextLine());
//            Gamer gamer = new Gamer(mmr,name, server, lastTen);
