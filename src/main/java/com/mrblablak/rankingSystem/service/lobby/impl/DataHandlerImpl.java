...
import com.mrblablak.rankingSystem.model.*;
import com.mrblablak.rankingSystem.repository.*;
import com.mrblablak.rankingSystem.service.lobby.DataHandler;
import com.mrblablak.rankingSystem.service.lobby.MmrCalculator;
...
public class DataHandlerImpl implements DataHandler {
    ...
    private void setHandicap(Gamer[] team1gamers, Gamer[] team2gamers){
        for (int i = 0; i < TEAM_SIZE; i++) {
            team1gamers[i].setMmr(team1gamers[i].getMmr() - ServerUtils.calculateHandicap(team1gamers[i].getServer(), server));
            team2gamers[i].setMmr(team2gamers[i].getMmr() - ServerUtils.calculateHandicap(team2gamers[i].getServer(), server));
        }
    }
